...
string Feat::get_name() {
    return (name);
};

void Feat::set_name(string newname) {
    name = newname;
};
...
float ClassFeat::get_sig_limit() {
    return(3.84);
};

float ClassFeat::get_p_limit() {
    return(0.95);
};
...
float RegrFeat::get_p_limit() {
    return(sig_thr);
};

float RegrFeat::get_global_median(string act) {
    return(global_median[act]);
};

float RegrFeat::get_median(string act) {
    return(median[act]);
};

float RegrFeat::get_p(string act) {
    return(p[act]);
};
...
vector<string> LinFrag::get_fragment() {
    return (fragment);
};
